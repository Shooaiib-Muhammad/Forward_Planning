<aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="<?php echo base_url()?>dashboard" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
                            ...
                            <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2">Planning</span>
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <li >
                                <a href="#" title="Application Intel" data-filter-tags="application intel">
                                    <i class="fa fa-angle-double-down"></i>
                                    <span class="nav-link-text" data-i18n="nav.application_intel">Planning</span>
                                </a>
                                <ul>
                                  <li>
